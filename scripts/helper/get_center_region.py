...
def is_brighter_than_dark(image, known_dark_image, threshold=20):
...
def get_center_region(filename, known_dark_image):
    ...
    return is_brighter_than_dark(center_region, known_dark_image)
...
if __name__ == '__main__':
    ...
    print(get_center_region(filename, known_dark_image))
